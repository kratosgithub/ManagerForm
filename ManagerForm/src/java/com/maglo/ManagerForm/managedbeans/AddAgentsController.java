 ...
 *
 * @author NDOZENG
 * Classe utilitaire permettant de creer un agent ou <!-- Technicien --> dans le systeme.
 */

@ManagedBean
@SessionScoped 
public class AddAgentsController implements Serializable {
    
    // Declaration des variables de la classe
    private static final long serialVersionUID = 1L;
    
    private static final Logger logger = Logger.getLogger(AddAgentsController.class.getName());
    ...
    /**
     * User (Manager) : saveAgent()
     * Description : Méthode permettant d'enregistrer un nouvel agent.
     * @return 
     */
    public String saveAgent() {
        ...
        // On crée le nouvel agent
        uejb.createAgent(users);
        
        // Logger Info
        logger.info("CREATE : Un nouvel agent a été enregistré avec succès. Le : " + format.format(date) + ".");
         ...
         */
        Util.messageInfo("M/Mme. " + users.getPrenom() + " " + users.getNom() + " a été enregistré avec succès.", "Information :");
        
        return "success"; 
    }// fin saveAgent()
    
}// fin de la classe AddAgentsController 
