 ...
 *
 * @author NDOZENG
 * Classe utilitaire permettant de créer un utilisateur avec le profil <!-- User-->.
 */
...
public class AddUserController implements Serializable {
    ...
    /**
     * User (User) : saveUser()
     * Description : Méthode permettant d'enregistrer un nouveau utilisateur.
     * @return 
     */
    public String saveUser() {
        // Initialisation d'un nouveau user
        Users users = new Users(nom, prenom, login, password, tel);
        
        // On crée le nouveau manager
        uejb.createUser(users); 
        
        // Logger Info
        logger.info("SIGN UP : Un nouvel utilisateur a été enregistré avec succès. Le : " + format.format(date) + ".");
...
}// fin de la classe AddUserController
