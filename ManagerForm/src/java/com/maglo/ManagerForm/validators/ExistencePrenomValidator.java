...
@ManagedBean
@RequestScoped
public class ExistencePrenomValidator implements Validator {
    
    // Declaration des variables de la classe
    private static final String MESSAGE_INFO = "Ce prénom existe déjà. Veuillez saisir un autre prénom.";
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        try {// essai 
            if(uejb.getUserByPrenom(prenom) != null) {
                /**
...
}// fin de la classe ExistencePrenomValidator
