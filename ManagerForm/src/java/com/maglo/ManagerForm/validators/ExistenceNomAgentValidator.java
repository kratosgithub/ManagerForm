 ...
 * Classe utilitaire permettant de verifier l'existence du nom d'un technicien déjà enregistré dans 
 * le systeme. 
 */

@ManagedBean
@RequestScoped 
public class ExistenceNomAgentValidator implements Validator {
...
}// fin de la classe ExistenceNomAgentValidator 
