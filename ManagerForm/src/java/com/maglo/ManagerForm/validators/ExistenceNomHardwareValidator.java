 ...
 * Classe utilitaire permettant de verifier l'existence d'un nom d'équipement déjà enregistré
 * dans le système.
 */

@ManagedBean
@RequestScoped 
public class ExistenceNomHardwareValidator implements Validator {
    ...
    public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
        ...
        String nomHardware = (String) value;
...
}// fin de la classe ExistenceNomHardwareValidator
